...
export interface GongCallDetails {
  ...
  content?: {
    ...
    trackers?: Array<{ name: string; count: number; occurrences: Array<{ startTime: number }> }>;
    pointsOfInterest?: {
      actionItems?: Array<{ snippet: string; speakerId: string }>;
    };
  };
  interaction?: {
    interactionStats?: Array<{ name: string; value: number }>;
    speakers?: Array<{ id: string; talkTime: number; userId?: string }>;
  };
}
